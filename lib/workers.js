...
// Perform the checks, send the originalCheckData and the outcome of the check to the next step in the process
workers.performCheck = function (originalCheckData) {
  ...
  // Parse the hostnaem and the path out of the originalCheckData
  ...
  // Instantiate the request object using https or http module
...
workers.alertUserToStatusChange = function (newCheckData) {
  ...
  helpers.sendTwilioSms("17655306237", msg, function (err) {
    if (!err) {
      debug(
